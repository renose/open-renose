...
<?php    
    echo $form->create('ReportInstruction');
    
    echo $form->input('Report.id');
    echo $form->input('title', array('label' => 'Unterweisung'));
    echo $form->input('text', array('label' => 'Unterweisungs Inhalt'));

    echo $form->end('Unterweisung hinzufügen');
