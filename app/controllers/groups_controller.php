...
class GroupsController extends AppController
{
    ...
    function edit($name)
    {
        ...
        if (empty($this->data))
        {
            ...
            $this->set('controllers', $this->ControllerList->get($this->data['GroupPermission']));
        ...
        else if ($this->Group->save($this->data))
        {
            ...
            $this->redirect( array('action' => 'view', $this->data['Group']['name']) );
        }
    }

    function permission($do, $name, $controller, $action)
    {
        if(!$this->params['isAjax'])
            return;
        if($do != 'allow' &&
